    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <header className="bg-white border-b border-gray-200 px-4 py-3 sticky top-0 z-10 shadow-sm flex justify-between items-center">
        ...
        <form action={logoutAction}>
          <Button
            variant="ghost"
            size="sm"
            className="text-gray-500 hover:text-red-600 hover:bg-red-50 gap-1 h-8 px-2"
            type="submit"
          >
      ...
      <main className="p-4 pb-20 max-w-2xl mx-auto">
        ...
        <div className="space-y-4">
          <h2 className="text-sm font-semibold text-gray-600 uppercase tracking-wider flex items-center mb-4">
          ...
          {batches.length === 0 ? (
            ...
            batches.map((batch) => {
              ...
              return (
                <Card
                  key={batch.id}
                  className="overflow-hidden border-l-4 border-l-green-600 shadow-sm hover:shadow-md transition-shadow bg-white"
                >
                  {/* 卡片头部：批次号 + 状态 */}
                  ...
                  <CardFooter className="bg-gray-50 py-2 px-4 flex gap-2 border-t border-gray-100">
                    <Link
                    ...
                    >
                      <Button
                        variant="default"
                        className="w-full bg-green-600 hover:bg-green-700 h-9 text-xs shadow-sm"
                      >
                    ...
                    <Link href={`/trace/${batch.batch_no}`} className="flex-1">
                      <Button
                        variant="outline"
                        className="w-full h-9 text-xs bg-white text-gray-600 hover:bg-gray-50"
                      >

					...
					<div className="flex flex-col space-y-4">
						<div className="relative w-full">
							...
							<Input
								...
								className="pl-10 h-12 text-lg border-green-200 focus-visible:ring-green-500 bg-green-50/30"
								value={traceId}
						...
						<Button
							...
							className="w-full h-12 text-lg bg-green-600 hover:bg-green-700 text-white shadow-md shadow-green-200"
						>
							立即查询
						</Button>
					</div>
